...
var value;
var GaugeValueInputUpdate_t1;
// // var value1=0;
Shiny.addCustomMessageHandler("myCallbackHandlert1",         
    function(GaugeValueInputUpdate_t1) {
	
	var element = document.getElementById('svg_id_t1');
		if (element !=null) {
			element.parentNode.removeChild(element);
		};
	
     value=GaugeValueInputUpdate_t1;
...
var barWidth, chart, chartInset, degToRad, repaintGauge,
  ...
  el = d3.select('.chart-gauge-t1');
    el.attr('id','chart-gauge-t1');
...
/////////
  ...
  var Needle = (function() {
    ...
    Needle.prototype.render = function() {
      ...
      return this.el.append('path').attr('class', 'needle').attr('id', 'client-needle_t1').attr('d', recalcPointerPos.call(this, 0));
